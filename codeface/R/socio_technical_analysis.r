...
## Compute an edgelist
co.change.dat <- compute.item.sets.edgelist(freq.item.sets)
...
co.change.edgelist <- as.character(with(co.change.dat, ggplot2:::interleave(X1, X2)))
g <- add.edges(g, co.change.edgelist)
